from data.data_pipe import de_preprocess, get_train_loader, get_val_data, get_train_loader_VTT
...
class face_learner(object):
    def __init__(self, conf, inference=False):
        ...
        if not inference:
            ...
            self.agedb_30, self.cfp_fp, self.lfw, self.agedb_30_issame, self.cfp_fp_issame, self.lfw_issame = get_val_data('./data/AnotherMissOh/Face')
        else:
