...
from Yolo_v2_pytorch.src.anotherMissOh_dataset import AnotherMissOh, Splits, SortFullRect, PersonCLS, ObjectCLS
...
def test(opt):
    ...
    # define person model
    model1 = object_model(num_object)
    ...
    for iter, batch in enumerate(test_loader):
        ...
        for idx, frame in enumerate(frame_id):
            ...
            save_dir = './results/object/{}/{}/{}/'.format(
                f_info[4], f_info[5], f_info[6])

            save_mAP_gt_dir = './results/input_object/ground-truth/'
            save_mAP_det_dir = './results/input_object/detection/'
            save_mAP_img_dir = './results/input_object/image/'
